...
![](external/images/unit7/bin-tern-rounded-bin-diagram.svg)

Below is an example of a rounded binary form. 

![](external/images/unit7/bin-tern-rounded-bin-k284-A.svg)

![](external/images/unit7/bin-tern-rounded-bin-k284-B.svg)

![](external/images/unit7/bin-tern-rounded-bin-k284-C.svg)

![](external/images/unit7/bin-tern-rounded-bin-k284-D.svg)

Figure 24.4.1. Mozart, Piano Sonata in D major, K. 284, III.

![](external/images/unit7/bin-tern-rounded-bin-k284-DIAGRAM.svg)
...
![](external/images/unit7/bin-tern-rounded-bin-schubertD41-A.svg)

![](external/images/unit7/bin-tern-rounded-bin-schubertD41-B.svg)

![](external/images/unit7/bin-tern-rounded-bin-schubertD41-C.svg)
