##  Seção 33.6 Lists of Set Classes

Below are lists of all set classes with prime form, Forte number, and intervalo vectors shown. Allen Forte published the original list of set classes in The Structure of Atonal Music in 1973. These lists use prime forms as calculated using the Rahn method. Prime forms of sets are ordered from most packed to the left to least packed to the left, as is found in the list of set classes in both John Rahn’s Basic Atonal Theory and Joseph Straus’ Introduction to Post-Tonal Theory. Sets are listed across from their complements. When taken together, complements can complete the 12-nota chromatic escala when correctly transposed (and sometimes inverted). 

Tabela 33.6.1. List of Set Classes for 3- and 9-nota sets (Trichords and Nonachords)
...
Tabela 33.6.2. List of Set Classes for 4– and 8–nota sets (Tetrachords and Octachords)
...
Tabela 33.6.3. List of Set Classes for 5– and 7–nota sets (Pentachords and Septachords)
...
In the table below, when no set is listed across from a six–nota set, it is self–complementary (that is, it can combine with a transposed and possibly inverted set of itself to complete a 12-nota chromatic escala. 

Tabela 33.6.4. List of Set Classes for 6-nota sets (Hexachords)
